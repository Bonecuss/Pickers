...
(function (root, factory) {
    ...
    PickerUI.prototype.getItemElem = function(item, settings) {
        ...
        if (item.image || this.options.getItemImageUrl) {
            itemContent = $('<img style="border:5px solid transparent;    border-radius:5%;    background:rgb(73,49,32);" src="' + (this.options.getItemImageUrl ? this.options.getItemImageUrl(item, settings) : item.image) + '" alt="' + itemName + '" title="' + itemName + '">' + '<br><span>' + itemName + '</span>');
        }
        else {
